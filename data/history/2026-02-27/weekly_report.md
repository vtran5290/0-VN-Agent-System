# Weekly Macro/Policy/Decision Packet — as-of 2026-02-27
_Report age: 15 day(s); market snapshot date: 2026-02-27_
...
- MARKET (levels): vnindex_level=1880.33, vn30_level=2061.75, distribution_days_rolling_20=9 (proxy: VN30)
- **Distribution (LB=25, refined):** VN30=9, HNX=6, UPCOM=5 → Composite=High (leader=VN30)
...
- WHAT CHANGED (WoW):
  - VNIndex Δ: -5719.67, Dist days Δ: None
...
- Market risk flag (dist days): {'distribution_days_rolling_20': 9, 'distribution_days': {'vn30': 9, 'hnx': 6, 'upcom': 5}, 'dist_risk_composite': 'High', 'dist_proxy_symbol': 'VN30', 'risk_flag': 'High', 'force_reduce_gross': True}
