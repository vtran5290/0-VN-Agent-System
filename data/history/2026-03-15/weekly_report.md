# Weekly Macro/Policy/Decision Packet — as-of 2026-03-15
_Report age: 0 day(s); market snapshot date: 2026-03-15_
...
- FACTS (levels):
  ...
  - NFP: 158466.0
- WHAT CHANGED (WoW):
  - UST 2Y Δ: 0.33999999999999986
  - UST 10Y Δ: 0.25
  - DXY Δ: 1.4993000000000052
...
- MARKET (levels): vnindex_level=1696.24, vn30_level=1853.6, distribution_days_rolling_20=4 (proxy: VN30)
- **Distribution (LB=25, refined):** VN30=8, HNX=7, UPCOM=7 → Composite=High (leader=VN30)
- **Action bias:** No new buys; only manage risk/exits; raise cash into strength.
- Breadth: VN30 trend_ok(>MA20)=False | HNX close=245.84, trend_ok(>MA20)=False | UPCOM close=124.66, trend_ok(>MA20)=False
- **Broad market weak:** HNX and UPCOM both below MA20.
- WHAT CHANGED (WoW):
  - VNIndex Δ: -5903.76, Dist days Δ: None
...
- Market risk flag (dist days): {'distribution_days_rolling_20': 4, 'distribution_days': {'vn30': 8, 'hnx': 7, 'upcom': 7}, 'dist_risk_composite': 'High', 'dist_proxy_symbol': 'VN30', 'risk_flag': 'High', 'force_reduce_gross': True}
