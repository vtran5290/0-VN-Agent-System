# Weekly Macro/Policy/Decision Packet — as-of 2026-03-25
_Report age: 0 day(s); market snapshot date: 2026-03-25_

**Data confidence:** Medium | missing: vietnam.omo_net
...
- WHAT CHANGED (WoW):
  - OMO net Δ: None
  - Interbank ON Δ: 3.8100000000000005
...
- MARKET (levels): vnindex_level=1658.19, vn30_level=1814.73, distribution_days_rolling_20=8 (proxy: VN30)
- **Distribution (LB=25, refined):** VN30=8, HNX=7, UPCOM=6 → Composite=High (leader=VN30)
- **Action bias:** No new buys; only manage risk/exits; raise cash into strength.
- Breadth: VN30 trend_ok(>MA20)=False | HNX close=249.67, trend_ok(>MA20)=True | UPCOM close=123.81, trend_ok(>MA20)=False
- WHAT CHANGED (WoW):
  - VNIndex Δ: -38.049999999999955, Dist days Δ: 4
...
- P(VNIndex breakout within 1m): 0.4
...
- Market risk flag (dist days): {'distribution_days_rolling_20': 8, 'distribution_days': {'vn30': 8, 'hnx': 7, 'upcom': 6}, 'dist_risk_composite': 'High', 'dist_proxy_symbol': 'VN30', 'risk_flag': 'High', 'force_reduce_gross': True}
...
- VCI: HOLD | No violation (tier=3)
- MBS: HOLD | No violation (tier=3)
- SHS: HOLD | No violation (tier=3)
- MBB: HOLD | No violation (tier=3)
- STB: HOLD | No violation (tier=3)
- DCM: HOLD | No violation (tier=3)
- PVD: HOLD | No violation (tier=3)
- PC1: HOLD | No violation (tier=3)
- REE: HOLD | No violation (tier=3)
- MWG: HOLD | No violation (tier=3)

## Portfolio Health
- **% positions below MA20:** 9.1% (1/11)
- **% positions with sell/trim active:** 9.1% (1/11)
- **Avg R multiple (open):** — (add r_multiple in tech_status)
- **Risk concentration by sector:**
  - Securities: 36.4% (4)
  - Banking: 18.2% (2)
  - Fertilizer/Chemical: 9.1% (1)
  - Oil services: 9.1% (1)
  - Power: 9.1% (1)
  - Energy/Utility: 9.1% (1)
  - Retail: 9.1% (1)
