# Weekly Macro/Policy/Decision Packet — as-of 2026-04-01
_Report age: 0 day(s); market snapshot date: 2026-04-01_

**Data confidence:** Medium | missing: vietnam.omo_net | not_due_yet: — | warnings: dxy_ice_unavailable_fail_closed (use usd_broad_index_fred for broad USD)
**Market level source:** VNINDEX | **DistDays proxy:** VN30
## Global Macro + Fed
- FACTS (levels) + source tag:
  - UST 2Y: 3.82 — FRED DGS2, **value_date**=2026-03-30 (fred_dgs_daily_observation; not labeled as broker session close)
  - UST 10Y: 4.35 — FRED DGS10, **value_date**=2026-03-30 (fred_dgs_daily_observation)
  - **ICE DXY (display):** None — proxy value_date=None (Yahoo/Stooq; **not** FRED DTWEXBGS)
  - **USD broad (FRED DTWEXBGS):** 120.8851 (value_date=2026-03-27)
  - CPI YoY: 2.41 — source=bls, **reference_month**=2026-02, value_date=2026-02
  - Nonfarm payroll **MoM change (persons):** -92000 (PAYEMS level date=2026-02-01)
  - Nonfarm payroll **level (thousands):** 158466.0 (prior level date=2026-01-01)
  - Legacy field `nfp` (intentionally null): None
- WHAT CHANGED (WoW):
  - UST 2Y Δ: 0.06000000000000005
  - UST 10Y Δ: 0.08000000000000007
  - ICE DXY Δ: None
  - USD broad (DTWEXBGS) Δ: None
  - Payroll MoM Δ persons: None
- INTERPRETATION: TBD when data is filled.
  - _Note:_ `ust_2y` value_date (2026-03-30) is **before** report as-of (2026-04-01).
  - _Note:_ `ust_10y` value_date (2026-03-30) is **before** report as-of (2026-04-01).
  - _Note:_ `usd_broad_index_fred` value_date (2026-03-27) is **before** report as-of (2026-04-01).
  - _Note:_ `nonfarm_payroll_level_thousands` value_date (2026-02-01) is **before** report as-of (2026-04-01).
  - _Note:_ `nonfarm_payroll_change_persons` value_date (2026-02-01) is **before** report as-of (2026-04-01).
...
- MARKET (levels): vnindex_level=1702.93, vn30_level=1861.84, distribution_days_rolling_20=7 (proxy: VN30)
- **Distribution (LB=25, refined):** VN30=7, HNX=6, UPCOM=6 → Composite=High (leader=VN30)
- **Action bias:** No new buys; only manage risk/exits; raise cash into strength.
- Breadth: VN30 trend_ok(>MA20)=True | HNX close=251.46, trend_ok(>MA20)=True | UPCOM close=127.75, trend_ok(>MA20)=True
- WHAT CHANGED (WoW):
  - VNIndex Δ: 6.690000000000055, Dist days Δ: 3
...
- Market risk flag (dist days): {'distribution_days_rolling_20': 7, 'distribution_days': {'vn30': 7, 'hnx': 6, 'upcom': 6}, 'dist_risk_composite': 'High', 'dist_proxy_symbol': 'VN30', 'risk_flag': 'High', 'force_reduce_gross': True}
