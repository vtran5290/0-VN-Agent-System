# Weekly Macro/Policy/Decision Packet — as-of 2026-04-08
_Report age: 0 day(s); market snapshot date: 2026-04-08_
...
- FACTS (levels) + source tag:
  - UST 2Y: 3.84 — FRED DGS2, **value_date**=2026-04-06 (fred_dgs_daily_observation; not labeled as broker session close)
  - UST 10Y: 4.34 — FRED DGS10, **value_date**=2026-04-06 (fred_dgs_daily_observation)
...
- WHAT CHANGED (WoW):
  - UST 2Y Δ: 0.08000000000000007
  - UST 10Y Δ: 0.07000000000000028
  - ICE DXY Δ: None
  - USD broad (DTWEXBGS) Δ: None
  - Payroll MoM Δ persons: None
- INTERPRETATION: TBD when data is filled.
  - _Note:_ `ust_2y` value_date (2026-04-06) is **before** report as-of (2026-04-08).
  - _Note:_ `ust_10y` value_date (2026-04-06) is **before** report as-of (2026-04-08).
  - _Note:_ `usd_broad_index_fred` value_date (2026-04-03) is **before** report as-of (2026-04-08).
  - _Note:_ `nonfarm_payroll_level_thousands` value_date (2026-03-01) is **before** report as-of (2026-04-08).
  - _Note:_ `nonfarm_payroll_change_persons` value_date (2026-03-01) is **before** report as-of (2026-04-08).
...
- MARKET (levels): vnindex_level=1677.54, vn30_level=1840.96, distribution_days_rolling_20=8 (proxy: VN30)
- **Distribution (LB=25, refined):** VN30=8, HNX=5, UPCOM=4 → Composite=High (leader=VN30)
- **Action bias:** No new buys; only manage risk/exits; raise cash into strength.
- Breadth: VN30 trend_ok(>MA20)=True | HNX close=246.7, trend_ok(>MA20)=False | UPCOM close=126.27, trend_ok(>MA20)=True
- **Index holding but breadth weak → breakout failure risk ↑**
- WHAT CHANGED (WoW):
  - VNIndex Δ: -18.700000000000045, Dist days Δ: 4
...
- Market risk flag (dist days): {'distribution_days_rolling_20': 8, 'distribution_days': {'vn30': 8, 'hnx': 5, 'upcom': 4}, 'dist_risk_composite': 'High', 'dist_proxy_symbol': 'VN30', 'risk_flag': 'High', 'force_reduce_gross': True}
