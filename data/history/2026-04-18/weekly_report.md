# Weekly Macro/Policy/Decision Packet — as-of 2026-04-18
_Report age: 0 day(s); market snapshot date: 2026-04-18_
...
- FACTS (levels) + source tag:
  ...
  - **DXY third-party proxy (Yahoo DX-Y.NYB):** 76961.25 (value_date=2026-04-18) — cross-check, not licensed ICE; source=Yahoo Finance DX-Y.NYB
...
- INTERPRETATION: TBD when data is filled.
  - _Note:_ `ust_2y` value_date (2026-04-16) is **before** report as-of (2026-04-18).
  - _Note:_ `ust_10y` value_date (2026-04-16) is **before** report as-of (2026-04-18).
  - _Note:_ `usd_broad_index_fred` value_date (2026-04-10) is **before** report as-of (2026-04-18).
  - _Note:_ `nonfarm_payroll_level_thousands` value_date (2026-03-01) is **before** report as-of (2026-04-18).
  - _Note:_ `nonfarm_payroll_change_persons` value_date (2026-03-01) is **before** report as-of (2026-04-18).
  - _Note:_ `dxy_reconstructed` value_date (2026-04-10) is **before** report as-of (2026-04-18).

## Vietnam Policy + Liquidity
- FACTS (levels):
  - OMO net: 3077 (verification=parsed, source=sbv, detail=SBV nghiệp vụ thị trường mở (HTML scrape))
...
- MARKET (levels): vnindex_level=1817.17, vn30_level=1988.11, distribution_days_rolling_20=5 (proxy: VN30)
- **Distribution (LB=25, refined):** VN30=5, HNX=5, UPCOM=4 → Composite=Elevated (leader=VN30)
- Breadth: VN30 trend_ok(>MA20)=True | HNX close=260.0, trend_ok(>MA20)=True | UPCOM close=128.95, trend_ok(>MA20)=True
- WHAT CHANGED (WoW):
  - VNIndex Δ: 120.93000000000006, Dist days Δ: 1
