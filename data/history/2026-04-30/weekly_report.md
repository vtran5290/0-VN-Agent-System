# Weekly Macro/Policy/Decision Packet — as-of 2026-04-30
_Report age: 0 day(s); market snapshot date: 2026-04-30_

**Data confidence:** High | missing: — | not_due_yet: — | warnings: —
**Market level source:** VNINDEX | **DistDays proxy:** VN30
## Global Macro + Fed
- FACTS (levels) + source tag:
  - UST 2Y: 3.84 — FRED DGS2, **value_date**=2026-04-28 (fred_dgs_daily_observation; not labeled as broker session close)
  - UST 10Y: 4.36 — FRED DGS10, **value_date**=2026-04-28 (fred_dgs_daily_observation)
  - **DXY reconstructed (FRED H.10, ICE-style):** 98.5373 (value_date=2026-04-24)
  - **DXY third-party proxy (Yahoo DX-Y.NYB):** None (value_date=2026-04-29) — cross-check, not licensed ICE; source=Yahoo Finance DX-Y.NYB
...
- INTERPRETATION: TBD when data is filled.
  - _Note:_ `ust_2y` value_date (2026-04-28) is **before** report as-of (2026-04-30).
  - _Note:_ `ust_10y` value_date (2026-04-28) is **before** report as-of (2026-04-30).
  - _Note:_ `usd_broad_index_fred` value_date (2026-04-24) is **before** report as-of (2026-04-30).
  - _Note:_ `nonfarm_payroll_level_thousands` value_date (2026-03-01) is **before** report as-of (2026-04-30).
  - _Note:_ `nonfarm_payroll_change_persons` value_date (2026-03-01) is **before** report as-of (2026-04-30).
  - _Note:_ `dxy_reconstructed` value_date (2026-04-24) is **before** report as-of (2026-04-30).
