...
| Field | Value |
|-------|-------|
| Generated | 2026-05-29T16:03:02.102014+07:00 |
| Mode | pre-atc |
| Session | CLOSED |
| Active setups | 106 |
...
| Quoted / scan / missing quote | 106 / 106 / 0 |
...
- **equity panel EOD max date:** 2026-05-29
- **scan panel as-of (with intraday bars):** 2026-05-29
- **quotes fetched:** 106 / 106
- **intraday_quote_coverage_pct:** 100.0%
- **quoted_symbols_count:** 106
- **scan_symbols_count:** 106
...
- **EOD VNINDEX as-of:** 2026-05-29 close=1863.49
...
**Counts:** `HOLD_T1_ONLY`=4, `NEW_T1_MANUAL_REVIEW_BREADTH`=2, `NO_T2_BREADTH`=11, `TP1_PARTIAL`=3, `TRAIL_EXIT`=44, `WATCH_ONLY`=42
...
- Symbols in both: **106**; action changed IF_CLOSE_NOW: **1**
