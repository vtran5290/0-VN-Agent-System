...
## Breadth Operating Rules

| A3 breadth | Action |
|------------|--------|
| > 40% | Normal entries allowed |
| 35–40% | Caution zone — allow high-quality T1 entries only, no new T2 adds |
| < 35% | No new T2 adds. No new live entries unless manually overridden. |
| VNINDEX bear regime | No new live entries. Review existing positions. Do not auto-exit unless exit rule triggers. |
...
- [ ] Breadth gate live (pct_cloud_bull_20_100 computed daily)
...
| A3 breadth gate | 40% caution, 35% hard stop |

---

## Open Items

See FINAL_OPEN_ITEMS.md for complete list of done / rejected / pending / optional items.
