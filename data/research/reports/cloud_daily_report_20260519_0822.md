# Cloud Daily Report — 2026-05-19 08:22 UTC

**Mode:** PRE-LUNCH PREVIEW | **VNINDEX:** UNKNOWN | **Breadth:** DEFENSE | **T1:** OK | **T2:** BLOCKED
...
- Do not duplicate held positions: PVS
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| GSP | NEW_T1_MANUAL_REVIEW_BREADTH | 0.83 | 11.70 | pending* | pending* | pending* | Signal confirmed today; fill next session open |
| PVS | NEW_T1_MANUAL_REVIEW_BREADTH | 0.67 | 42.50 | 40.80 | 50.15 | 40.12 |  |
| OIL | NEW_T1_MANUAL_REVIEW_BREADTH | 0.36 | 17.00 | pending* | pending* | pending* | Signal confirmed today; fill next session open |

*pending = signal confirmed today; planned fill is next session open*
