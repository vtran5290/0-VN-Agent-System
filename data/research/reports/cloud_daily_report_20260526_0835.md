# Cloud Daily Report — 2026-05-26 08:35 UTC
...
| Symbol | C3 Rating | Bucket | #Top50 | T2 ctx | Late Chase | final_action | EMA dist% |
| --- | --- | --- | --- | --- | --- | --- | --- |
| DXS | 99 | LEADER | — | Y | WARN | NEW_T1_MANUAL_REVIEW_BREADTH | +212.0% |
| LPB | 97 | LEADER | #3 | Y | WARN | NO_T2_BREADTH | +564.0% |
| CII | 98 | LEADER | #1 | Y | — | WATCH_ONLY | — |
| VCG | 98 | LEADER | #2 | Y | — | TRAIL_EXIT | -322.0% |
| APS | 98 | LEADER | — | Y | — | WATCH_ONLY | — |
| L40 | 96 | LEADER | — | Y | — | WATCH_ONLY | — |
| DXG | 93 | LEADER | #4 | Y | — | WATCH_ONLY | — |
| HHS | 93 | LEADER | #5 | Y | — | TRAIL_EXIT | -501.0% |
| TCH | 93 | LEADER | #6 | Y | — | TRAIL_EXIT | -490.0% |
| NVL | 92 | LEADER | #7 | Y | — | TRAIL_EXIT | -661.0% |
| HDG | 92 | LEADER | #8 | Y | — | TRAIL_EXIT | -644.0% |
| GEX | 91 | LEADER | #9 | Y | — | WATCH_ONLY | — |
| NRC | 90 | LEADER | — | Y | — | TRAIL_EXIT | -197.0% |
| ASM | 89 | LEADER | — | Y | — | WATCH_ONLY | — |
| VIX | 88 | LEADER | #10 | Y | — | WATCH_ONLY | — |
