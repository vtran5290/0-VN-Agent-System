# Cloud Daily Report — 2026-05-27 08:51 UTC
...
- Review next-open candidate(s): VEA (pending levels)
...
| ACB | 23.3→25.2 | +8.15% | +10.61% | -11.14% | +6.55% | +17.69% | Y | — | — | — | — | —/— |
| MSB | 13.9→15.0 | +7.91% | +10.37% | +1.23% | +17.91% | +16.68% | Y | Y | NO_T2_BREADTH | — | lead_1_5 | Y/Y |
| VND | 16.45→17.75 | +7.90% | +10.36% | -10.59% | +8.43% | +19.02% | Y | — | — | — | — | —/— |
