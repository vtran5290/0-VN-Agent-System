# Daily operator pack — 2026-05-15
...
## E. Compare summary
- Full compare: `D:\V\0. VN Agent System\data\trading\live\accounts\compare_20260515.md`
- Differences across 30M / 5B / 10B / 20B = **account size & liquidity capacity**, not A3 logic.

## F. Problems / warnings
- INVALID: workflow_aborted
- INVALID: traffic_light_red:A3_DSE_PILOT_PAPER_SMALL
- INVALID: traffic_light_red:A3_PROD_PAPER_5B
- INVALID: traffic_light_red:A3_SCALE_PAPER_10B
- INVALID: traffic_light_red:A3_SCALE_PAPER_20B
- WARNING: manual_review_pending:A3_DSE_PILOT_PAPER_SMALL
- WARNING: manual_review_pending:A3_PROD_PAPER_5B
- WARNING: manual_review_pending:A3_SCALE_PAPER_10B
- WARNING: reference_scan_sizing:A3_SCALE_PAPER_10B
- WARNING: manual_review_pending:A3_SCALE_PAPER_20B
...
- Manual review needed? Yes — see per-account queues.
