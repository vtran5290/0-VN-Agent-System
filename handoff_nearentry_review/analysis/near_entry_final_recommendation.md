...
| too_far        |  3302 | 10.39%     | 73.9%      | -6.7%      | 1.57x         |
...
| C_labels_no14pct  |         86820 | 96.3%          | 6.36%      | 66.6%      |
...
3. **>+14% hard reject confirmed?** PARTIAL — check data

4. **Recommendation**: Mode C (labels + hard reject >14%) with downside widening for A3
...
| too_far    |  4415 | 11.62%     | 74.9%      | -9.4%      | 1.83x         |
...
| C_labels_no14pct  |        116461 | 96.3%          | 6.10%      | 65.2%      |
...
4. **Recommendation**: Mode B (hard filter) for S3 — tighter downside validated
