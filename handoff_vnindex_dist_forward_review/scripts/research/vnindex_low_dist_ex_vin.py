...
# Handoff bundle: minimal parquet (VIC/VHM/VRE shares only). Full repo uses all_financial_data_quarterly_*.parquet.
QUARTERLY_FA = _REPO / "data" / "fireant_exports" / "financials" / "vin_basket_quarterly_shares.parquet"
