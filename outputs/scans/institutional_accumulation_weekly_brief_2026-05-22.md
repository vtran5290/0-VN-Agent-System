...
**As-of:** 2026-05-22 | **Methodology:** v1.1 | **Rows scored:** 1562  
...
**Operator HTML:** `outputs/scans/institutional_accumulation_operator_summary_2026-05-22.html` | **CSV:** `institutional_accumulation_2026-05-22.csv`
...
- Tier 1: **0** | Tier 2: **16** | Tier 3: **37** | Reject: **1509**
- Emerging accumulation (universe): **34**
- Top-tier fund-backed (Tier 1–3): **5**
- VIN distortion flags (Tier 1–3): **0**
- Dominant sector (Tier 1–2): **Unknown** (concentration warning: **False**)
- Emerging top count (JSON): **34**
...
- Workflow warnings: 4 elevated message(s) in operator summary
