...
**As-of:** 2026-06-02 | **Methodology:** v1.1 | **Rows scored:** 1562  
...
**Operator HTML:** `outputs/scans/institutional_accumulation_operator_summary_2026-06-02.html` | **CSV:** `institutional_accumulation_2026-06-02.csv`
...
- Tier 1: **0** | Tier 2: **13** | Tier 3: **29** | Reject: **1520**
- Emerging accumulation (universe): **20**
- Top-tier fund-backed (Tier 1–3): **4**
- VIN distortion flags (Tier 1–3): **0**
- Dominant sector (Tier 1–2): **Unknown** (concentration warning: **False**)
- Emerging top count (JSON): **20**
