...
**As-of:** 2026-07-09 | **Methodology:** v1.1 | **Rows scored:** 1562  
...
**Operator HTML:** `outputs/scans/institutional_accumulation_operator_summary_2026-07-09.html` | **CSV:** `institutional_accumulation_2026-07-09.csv`
...
- Tier 1: **0** | Tier 2: **21** | Tier 3: **33** | Reject: **1508**
- Emerging accumulation (universe): **27**
- Top-tier fund-backed (Tier 1–3): **2**
- VIN distortion flags (Tier 1–3): **0**
- Dominant sector (Tier 1–2): **Ngân hàng** (concentration warning: **False**)
- Emerging top count (JSON): **27**
...
**Changes since previous:** No meaningful tier or score changes vs previous scan.

## Validation & data integrity

- Workflow warnings: 5 elevated message(s) in operator summary
