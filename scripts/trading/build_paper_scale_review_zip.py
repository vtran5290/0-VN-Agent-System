#!/usr/bin/env python3
"""Build vn_auto_trading_paper_scale_review.zip for external AI review."""
...
OUT_ZIP = REPO / "vn_auto_trading_paper_scale_review.zip"
...
INCLUDE_PATHS = [
    ...
    "docs/trading/CHATGPT_PAPER_SCALE_ACCOUNTS_REVIEW_PROMPT.md",
    ...
    "scripts/trading/build_paper_scale_review_zip.py",
]
